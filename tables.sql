...
CREATE TABLE voting_center(
    center_id NUMBER(8) UNIQUE NOT NULL,
...
CREATE TABLE party(
    party_id NUMBER(8) UNIQUE NOT NULL,
    party_name VARCHAR(20) NOT NULL,
    party_symbol VARCHAR(20) NOT NULL UNIQUE,
    PRIMARY KEY(party_id)
);

CREATE TABLE candidates(
    candidate_id NUMBER(8) UNIQUE NOT NULL,
...
CREATE TABLE vote(
    vote_id NUMBER(10) UNIQUE NOT NULL,
